...
$(document).ready(function () {
			...
			"data":[
				{
					...
					"customer_image" : "assets/images/avatar-14.png",
					...
					"rating" : "4.2",
					"owner" : "Hendry Milner",
					"owner_image": "assets/images/avatar-14.png",
					"status" : "0",
					"Action" : ""
				},
				{
	...
	if($('#leads_list').length > 0) {
		$('#leads_list').DataTable({
				...
				"data":[
					{
						...
						"si_no" : "",
						"select" : "",
						"product_name" : "Water Soluble Fertilizer",
						"category" : "NPK 100% Water Soluble Fertilizer Range",
						"company_image" : "assets/images/water-soluble-fertilizer-pro-2.jpg",
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<a href="leads-details.html" class="title-name">'+row['product_name']+'</a>';
				}},
				{ "render": function ( data, type, row ){
	...
	// Deal List - order-management.html
					...
					"data":[
						{
							...
							"select" : "",
							"customer_name" : "Darlee Robertson",
							"customer_image" : "assets/images/avatar-19.jpg",
							"customer_no" : "Facility Manager",
							"created" : "25 Sep 2023, 12:12 pm",
				...
				"data":[
					{
						...
						"assigned_image" : "assets/images/avatar-19.jpg",
			...
			"bFilter": false, 
				...
				"data":[
					...
					},
					{
						...
						"company_name" : "SilverHawk",
						"company_image" : "assets/img/icons/company-icon-03.svg",
						"owner_image": "assets/images/avatar-19.jpg",
							"industry" : "Hotels",
						"type" : "Partner",
						"status" : "0",
						"Action" : ""
				...
				"data":[
					{
						...
						"value": "$03,50,000",
						"hrs": "100",
						"mem_image1" : "assets/images/avatar-19.jpg",
						"mem_image2": "assets/images/avatar-19.jpg",
						"mem_image3": "assets/images/avatar-19.jpg",
						"budget": "$200000",
						"currently_spend": "$40000",
						"Action" : ""
					},
