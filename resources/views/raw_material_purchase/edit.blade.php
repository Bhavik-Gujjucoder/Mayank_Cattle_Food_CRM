                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="raw_material_id" id="raw_material_id"
                            ...
                            {{ (string) old('raw_material_id', $raw_material_purchase->raw_material_id) === (string) $material->id ? 'selected' : '' }}>
                            {{ $material->name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="supplier_id" id="supplier_id"
                            ...
                            @foreach ($suppliers as $supplier)
                                <option value="{{ $supplier->id }}" {{ (string) old('supplier_id', $raw_material_purchase->supplier_id) === (string) $supplier->id ? 'selected' : '' }}>
                                    {{ $supplier->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="invoice_no" id="invoice_no" value="{{ old('invoice_no', $raw_material_purchase->invoice_no) }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="invoice_date" id="invoice_date" value="{{ old('invoice_date', $raw_material_purchase->invoice_date) }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="quantity" id="quantity" value="{{ old('quantity', $raw_material_purchase->quantity) }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $raw_material_purchase->unit_price) }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <textarea name="remarks" id="remarks"
                            ...
                            maxlength="500">{{ old('remarks', $raw_material_purchase->remarks) }}</textarea>
                    </div>
