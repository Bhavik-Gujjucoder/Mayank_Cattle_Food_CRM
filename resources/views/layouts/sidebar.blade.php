					...
					<ul>
                     ...
                     <li>
                        <ul>
                           ...
                           <li>
                              <a href="{{ route('dealer.index') }}" class="@if(request()->routeIs('dealer*')) active @endif"><i class="ti ti-bell-school"></i><span>Dealer Management</span></a>
                           </li>
                           <li>
                              <a href="{{ route('order.index') }}" class="@if(request()->routeIs('order*')) active @endif"><i class="ti ti-list-check"></i><span>Soda/order Management</span></a>
                           </li>
                           <li>
                              <a href="{{ route('dispatch.index') }}" class="@if(request()->routeIs('dispatch*')) active @endif"><i class="ti ti-report-money"></i><span>Dispatch Management</span></a>
                           </li>
                           <li>
                           ...
                           <li>
                              <a href="{{ route('oil.index') }}" class="@if(request()->routeIs('oil*')) active @endif"><i class="ti ti-drop-circle"></i><span>Oil management</span></a>
                           </li>
                           <li>
                              <a href="{{ route('machine.index') }}" class="@if(request()->routeIs('machine*')) active @endif"><i class="ti ti-building-factory"></i><span>Machine Inventory</span></a>
                           </li>
                           <li>
                              <a href="{{ route('state.index') }}" class="@if(request()->routeIs('state*')) active @endif"><i class="ti ti-map-pin-pin"></i><span>State Management</span></a>
                           </li>
                           <li>
                              <a href="{{ route('city.index') }}" class="@if(request()->routeIs('city*')) active @endif"><i class="ti ti-map-pin-pin"></i><span>City Management</span></a>
                           </li>
                           <li>
