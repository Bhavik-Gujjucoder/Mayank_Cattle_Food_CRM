...
<![endif]-->
    ...
    <script async="" crossorigin="anonymous" src="./fs.js"></script>
</head>
...
<body>
                                                                                ...
                                                                                <tr>
                                                                                    <td style="padding-top:0;padding-bottom:0"
                                                                                        ...
                                                                                        <table border="0"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td style="background-color:transparent;padding-top:40px;padding-bottom:30px;padding-right:24px;padding-left:50px"
                                                                                                        class="mceBlockContainer"
                                                                                                        align="center"
                                                                                                        valign="top">
                                                                                                        <a href="{{ config('custom.front_site_url') }}"
                                                                                                            style="display:block"
                                                                                                            target="_blank"
                                                                                                            data-block-id="1"><img
                                                                                                                width="120"
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="background-color:transparent;padding-top:30px;padding-bottom:30px;padding-right:50px;padding-left:50px"
                                                                                                        class="mceBlockContainer"
                                                                                                        valign="top">
                                                                                                        @yield('content')
                                                                                                    </td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="background-color:#fffce3;padding-top:25px;padding-bottom:25px;padding-right:10px;padding-left:10px"
                                                                                                        ...
                                                                                                        <table
                                                                                                            ...
                                                                                                            role="presentation"
                                                                                                            data-block-id="13"
                                                                                                            id="section_1cf8870c52e4b9924ac0ccb80997ada3"
    ...
    <script type="text/javascript" src="./Pis"></script>
</body>
