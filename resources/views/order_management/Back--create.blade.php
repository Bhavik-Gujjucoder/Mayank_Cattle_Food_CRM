            ...
            <form action="{{ route('order.store') }}" id="orderForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-4 order-form">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="unique_order_id" value="ORD000001" class="form-control" readonly>
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="brand_id" id="brand_id" class="form-control form-select search-dropdown">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="order_date" value="" id="datePicker" class="form-control"
                            placeholder="Transporter Amount">
                    </div>
                    <div class="col-md-4 mb-3">
