            ...
            <table class="table table-bordered order-product-table" id="itemTable">
                ...
                <tbody id="itemTableBody">
                    @foreach ($order->items as $index => $item)
                        <tr class="item-row">
                            <td class="row-index text-center fw-semibold">{{ $index + 1 }}</td>
                            <td>
                            ...
                            <td>
                                <input type="number" name="total_qty[]" class="form-control qty-field"
                                       value="{{ $item->total_qty }}" placeholder="0" min="1" step="1">
                            </td>
                            <td>
                            ...
                            <td class="text-center row-actions">
                                ...
                                <button type="button" class="btn-remove-row remove-row-btn" title="Remove row"
                                    style="{{ $order->items->count() > 1 ? '' : 'display:none;' }}">
...
$(document).ready(function () {
    ...
    $(document).on('click', '#addRowBtn', function () {
        ...
        updateRowButtons();
        reindexRows();
        initMaterialSelect($('#itemTableBody .item-row:last .material-select'));
    });
