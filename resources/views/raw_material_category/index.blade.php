        ...
        <div class="cls-cardhed-part">
            <div class="cls-form-left">
                ...
                <div class="common-hed-form cls-form-select-input d-flex align-items-end">
                    <button type="button" class="btn btn-light" id="resetCategoryFilters">
                ...
                <div class="comm-header-right-btn">
                    @can('export-raw-material-category')
                        <div class="btn-group me-2">
                            <button type="button" class="btn btn-outline-primary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false" id="exportCategoriesBtn">
                                <i class="ti ti-file-export me-2"></i>Export (0)
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item export-filtered-link" href="#" data-export-url="{{ route('raw-material.category.export') }}">
                                        <i class="ti ti-file-spreadsheet me-2"></i>Export Excel
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item export-filtered-link" href="#" data-export-url="{{ route('raw-material.category.export-list-pdf') }}">
...
$(document).ready(function () {
    ...
    const isShowAction = {{ auth()->user()->canAny(['edit-raw-material-category', 'delete-raw-material-category']) ? 'true' : 'false' }};
    ...
    var category_table = $('#raw_material_category_table').DataTable({
        ...
        columns: [
            ...
            { data: 'category_unique_id', name: 'category_unique_id', searchable: true },
        ...
        drawCallback: function () {
            ...
            if ($('#exportCategoriesBtn').length) {
                $('#exportCategoriesBtn').html('<i class="ti ti-file-export me-2"></i>Export (' + n + ')');
            }
        }
    });
