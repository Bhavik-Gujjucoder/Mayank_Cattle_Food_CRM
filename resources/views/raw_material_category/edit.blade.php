...
<div class="card raw-material-module">
    <div class="card-body">
        <form action="{{ route('raw-material.category.update', $category->id) }}" method="POST" id="categoryForm">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" value="{{ $category->category_unique_id }}" class="form-control fw-semibold" readonly>
                </div>
            ...
            <div class="d-flex align-items-center justify-content-end gap-2 mt-3 rm-form-actions">
                ...
                <button type="button" class="btn btn-primary px-5" id="submitCategoryBtn">Update Category</button>
            </div>
        </form>
    </div>
</div>
