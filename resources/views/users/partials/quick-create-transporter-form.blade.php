<form id="quickTransporterForm" action="{{ route('users.store', 'transporter') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="profile-pic-upload">
                <div class="profile-pic">
                    <img id="qt_profilePreview" src="{{ asset('images/default-user.png') }}" alt="Profile Picture"
                        class="img-thumbnail mb-2">
                </div>
                <div class="upload-content">
                    <div class="upload-btn">
                        <input type="file" name="profile_picture" accept=".jpg,.jpeg,.gif,.png"
                            class="qt-profile-input">
                        <span>
                            <i class="ti ti-file-broken"></i>Upload File
                        </span>
                    </div>
                    <p class="mb-0">JPG, JPEG, GIF or PNG. Max size of 2MB</p>
                    <span class="text-danger small qt-field-error" data-field="profile_picture"></span>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="name" class="form-control qt-input" placeholder="Name" maxlength="255">
            <span class="text-danger small qt-field-error" data-field="name"></span>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <span class="text-danger small qt-field-error" data-field="password"></span>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <span class="text-danger small qt-field-error" data-field="password_confirmation"></span>
        </div>
    </div>
</form>
